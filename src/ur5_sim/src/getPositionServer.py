...
class ObjectDetection(object):
    ...
    def camera_callback(self, data):
        ...
        mask_b = cv.inRange(hsv, blue_lower, blue_upper)
        mask = cv.adaptiveThreshold(mask_b, 255, cv.ADAPTIVE_THRESH_MEAN_C, cv.THRESH_BINARY_INV, 3, 3)
        ...
        for cnt in object_detected:
            ...
            #condition top right of the image
